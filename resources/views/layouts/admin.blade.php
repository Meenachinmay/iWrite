...
<head>
    ...
    <title>@yield('title', 'i-Write')</title>
    <meta charset="utf-8">
...
<script src="admin/assets/js/plugins/pace.min.js"></script>
<!-- Page specific javascripts-->
<script type="text/javascript" src="admin/assets/js/plugins/chart.js"></script>
