...
<aside class="app-sidebar">
    ...
    <ul class="app-menu">
        ...
        @if(Auth::user()->author)
            ...
            <li><a class="app-menu__item {{ Route::currentRouteName() == 'authorComments' ? 'active' : '' }}" href="{{ route('authorComments') }}"><i class="app-menu__icon fa fa-book"></i><span class="app-menu__label">Posts</span></a></li>
            <li><a class="app-menu__item {{ Route::currentRouteName() == 'authorPosts' ? 'active' : '' }}" href="{{ route('authorPosts') }}"><i class="app-menu__icon fa fa-comments-o"></i><span class="app-menu__label">Comments</span></a></li>
        @endif
